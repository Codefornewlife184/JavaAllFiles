package CoreJavaDay50.day49_Queue_Degue_Maps;
...
public class Maps02 {
	...
	public static void main(String[] args) {
		...
		// {101=Levent, 102=Said, 103=Hasan, 104=Canan, 105=Ayse}
		...
		m1.put(106, "Canan"); // ayni value farkli key'e atanabilir
		...
		System.out.println(m1);
		// {null=hakan, 101=harun, 102=Said, 103=Hasan, 104=Canan,
		// 105=Ayse, 106=Canan,107=null, 108=null, 109=null}
		System.out.println(m1.get(103)); // Hasan

		System.out.println(m1.values());
		// [hakan, harun, Said, Hasan, Canan, Ayse, Canan, null, null, null]
		// --> map'deki tüm elemanlarin value'lerini return eder.

		System.out.println(m1.keySet());
		// [null, 101, 102, 103, 104, 105, 106, 107, 108, 109]
		System.out.println(m1.getOrDefault
				(106, "boyle bir eleman yoktur")); // canan
		System.out.println(m1.getOrDefault
				(111, "boyle bir eleman yoktur"));
		// boyle bir eleman yoktur.

		m1.putIfAbsent(110, "ahmet");
		// belirtilen key creat edilmemisse creat edip value atamasi yapar
		// -->key 110 yoktu olusturup ahmet atadi.

		System.out.println(m1.putIfAbsent(110, "ahmet"));
		// belirtilen key yoksa NULL return eder
		System.out.println(m1);
		/* {null=hakan, 101=harun, 102=Said, 103=Hasan, 104=Canan,
		105=Ayse, 106=Canan,  107=null, 108=null, 109=null, 110=ahmet} */

		m1.putIfAbsent(105, "salih");
		// --> 105 Key'de Ayse value oldg icin salih put edilmedi
		System.out.println(m1.putIfAbsent(105, "salih"));
		// 105 key'deki value degeri Ayse return edildi
		System.out.println(m1);// {null=hakan, 101=harun, 102=Said, 103=Hasan, 104=Canan, 105=Ayse, 106=Canan,
		...
		m3.compute(109, (key, value) -> "merve hanim"); // 109 key'de olnadigi icin Entry' put eder
		System.out.println(m3);// {1=guzel, 2=insan, 3=javacan, 103=haluk, 104=Canan, 105=Ayse, 109=merve hanim}
		// --> 109 key'deki 109=merve hanim creat edildi...
		...
		System.out.println(m3);// {1=guzel, 2=insan, 3=javacan, 103=haluk, 104=Canan, 105=Ayse, 109=merve hanim,111=said ipek}
