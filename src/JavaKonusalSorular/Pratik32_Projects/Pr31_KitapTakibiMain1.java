...
public class Pr31_KitapTakibiMain1 {
	...
	public static void main(String[] args) {
		...
		Pr31_KitapTakipBilgileri2 kb = new Pr31_KitapTakipBilgileri2();
		...
		do {
			...
			case 1:
				...
				do {
					kb.kitapEkle();
					System.out.println(
							"Eklemek istediginiz baska bir kitap var mi? \nEvet icin 1'i Hayir icin 0'i tuslayiniz.");
					islem = scan.nextByte();
					scan.nextLine();
				} while (islem != 0);
			...
			case 4:
				do {
					...
					System.out.println(
							"Silmek istediginiz istediginiz baska bir kitap var mi? \\nEvet icin 1'i Hayir icin 0'i tuslayiniz.");
					islem = scan.nextByte();
				} while (islem != 0);
				break;
			case 5:
