package CoreJavaDay50.day45_Iterator01;
...
public class Iterator01 {
	public static void main(String[] args) {
		...
		// Mesela set de index olmaz... index olmayinca mecburen tum elemanlara ulasmak icin for each kullanilir..
		// Update ve delete yapamayiz..Bunun icin Java iterator interface olusturmustur
