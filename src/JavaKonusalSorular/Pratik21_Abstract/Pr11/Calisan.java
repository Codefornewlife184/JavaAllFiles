package JavaKonusalSorular.Pratik21_Abstract.Pr11;
...
public class Calisan extends Insan {
    ...
    calisanId==0 ise calisan degil aksi durumda calIsan oldugunu kontrol edip id si ile yazdiriniz
	...
	*/
	...
	// 4. adim
		if (calisanId==0) {
			...
			System.out.println("bu sahis bizim çalışan :)");
			System.out.println("sahsin id'si : "+calisanId);
		}
	}
