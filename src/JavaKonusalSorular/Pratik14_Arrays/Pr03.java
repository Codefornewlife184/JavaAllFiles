...
public class Pr03 {
	...
	public static void main(String[] args) {
			...
			/* Soru : Verilen 3 elemanli bir array in
			...
			System.out.println(Arrays.toString(arr2)); // [3, 9, 4, 5, 8, 9, 12, 15, 87, 87]
			arr2[arr2.length-1]=temp;
			System.out.println(Arrays.toString(arr2)); // [3, 9, 4, 5, 8, 9, 12, 15, 87, 1]
		}
	}