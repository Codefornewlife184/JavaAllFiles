package CoreJavaDay50.day20_Arrays;
import java.util.Arrays;
public class C04_Arrays04 {

	public static void main(String[] args) {
		String str = "Java, candir.";
		// split method'u bize bir array doner donen array'i ya direk yazdirmaliyiz...

		System.out.println(Arrays.toString(str.split(","))); // [Java,  candir.]
