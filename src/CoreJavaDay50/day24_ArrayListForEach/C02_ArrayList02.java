...
public class C02_ArrayList02 {
	public static void main(String[] args) {
		...
		/* Input olarak verilen 2 listeyi Parametre olarak kabul edip, ortak isimleri yazdiran bir method yaziniz
		...
		ortakList(list1, list2); // ortakList adında parametreli bir metod açıldı..
	}
