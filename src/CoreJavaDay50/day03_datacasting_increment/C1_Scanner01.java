...
public class C1_Scanner01 {
	...
	public static void main(String[] args) {
		...
		// next() metodu sadece ilk kelimeyi alir, girilen deger daha uzunsa ilk kelimeden sonrasi kalir
		// yani 2 isimli biriyse ikincisini yazmaz. nextLine iki isimliler icin olmalidir.
		// nextLine() metodu ise o satirin sonuna kadar girilen tum degerleri alir
