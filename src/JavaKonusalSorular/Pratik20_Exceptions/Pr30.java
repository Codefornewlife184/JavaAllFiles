...
public class Pr30 {
	...
	/*Eger kod creat edilirken  birden fazla exception durumu olusuyorsa
		...
		try {
			FileInputStream fis = new FileInputStream("C:\\Users\\ASUS\\eclipse-workspace" +
					"\\mehmetBulutluoz\\src\\TechProEd2021._01_JavaTechProEd.day39_exceptions\\File");
			int i=0;
			try {
				while ((i=fis.read()) !=-1) {
					System.out.print((char)i);
					// (i) yi ((char)k) yapinca ascii degerleri yerine file yazdirildi
				}
