...
public class Pr18_AtmProjesi1 {
	
	/*
	 * Kendimce mini bir ATM projesi olusturdum 
	 * bir ATM'de yapabilecegimiz islemleri bu proje'de yapabiliyoruz(
	 * Cikis isleminde fatura secenegi de ekledim 
	 * faturamizda faturanin tarihi ve saati de yaziyor:grinning:)
	 * 
	Kurallarimiz :
	--> Kart numarasi 16 haneli olmak zorunda
	--> Sifremiz basta belirledigimiz sifre ile eslesmek zorunda-sifre degistirme secenegi de sundum-
	--> Para gonderme secenegimiz de mevcut gondercegimiz kisinin IBAN numarasi 'TR' ile baslamali ve 26 haneli olmali
	--> Bakiyemizi asan islemler yapmamizi engelledim
	 */
