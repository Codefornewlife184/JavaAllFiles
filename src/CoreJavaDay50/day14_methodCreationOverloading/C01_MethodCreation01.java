...
public class C01_MethodCreation01 {
	...
	public static void istenenBasamaklariYazdir(int sayi) {
		...
		if (sayi<100) {
			...
			// sayi 100'den buyuk  455254
			// son 3 basamak toplamini istedigi icin 254 uzerinden islem yapmis olacagiz..
			...
			System.out.println("Birler,onlar ve yuzler basamagindaki rakamlar toplami : " + rakamlarToplami);
