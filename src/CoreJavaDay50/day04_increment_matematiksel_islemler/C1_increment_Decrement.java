...
public class C1_increment_Decrement {
	public static void main(String[] args) {
		...
		//sayi2 20 idi +10 daha 30 oldu. sayi2 artik 30 oldu.. sayi1 de 5 oldugu icin 30/5=6 olur..
		
		sayi1*=2;
		sayi2++;
		/* yazdirmak istersem sayi1 5 idi. balık hafizali oldugu icin 2 yi yani ilki alir. 
		2 ile carparak 10 bulur... sayi2++ ise en son islemde 30 olmustu... 30+1=31 olur*/
		System.out.println(sayi2/sayi1); // sonuc 31/10 dan 3.1 olmaz. tamsayi alir. 3 cevabini verir..
		
		sayi1 /=2 ;
		double sayi3 = sayi2/10;  
		/* sayi2 integer oldugundan sayi2/10 isleminin sonucunu java 3 olarak bulur ama atama islemi yapilirken 
		  sayi3 double oldugu icinbolme isleminin sonucu olan 3'u casting ile 3.0'a cevirir */
		...
		// sayi2 31 idi. 31/10=3.1 ama int oldugundan 3 kabul eder.
