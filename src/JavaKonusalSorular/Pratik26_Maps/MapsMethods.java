...
public class MapsMethods {
	...
	public static void main(String[] args) {
		...
		// Ayn� value farkli key'e atanabilir... Value'ler unique(benzersiz) olmak zorunda degil...
		m1.put(106, "Mehmet"); 
		System.out.println("1-put(key,value) methodu : " + m1); 
		...
		System.out.println("7-putIfAbsent(key, value) methodu : " + m1.putIfAbsent(105, "tahir"));
		// 7-putIfAbsent(key, value) methodu : Hasan
		// 105 Key'de Ayse value oldg icin tahir put edilmedi.. 105 key'deki value degeri Hasan return edildi
