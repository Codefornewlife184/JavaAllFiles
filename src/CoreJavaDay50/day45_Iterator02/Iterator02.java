package CoreJavaDay50.day45_Iterator02;
import java.util.*;
public class Iterator02 {
	...
	public static void main(String[] args) {
		...
		// list iterator interfaceden lt1 veriable creat edildi. degerini listten assingn edildi
		 ...
		 * oncesinde MUTLAKA KESINLIKLE hasNext() ve next(); method'lari calistirilarak
