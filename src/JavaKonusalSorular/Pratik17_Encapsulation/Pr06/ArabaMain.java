package JavaKonusalSorular.Pratik17_Encapsulation.Pr06;
...
public class ArabaMain {
    public static void main(String[] args) {
        ...
        honda.setMotor(2000);
        honda.setYil(2016);
        Araba toyota =new Araba("corolla","gri",1600,2020);
        //toyota obj parametreli cons ürettik
        Araba volvo =new Araba("s80","mavi",1600,-2020);
        //volvo obj parametreli cons ürettik
