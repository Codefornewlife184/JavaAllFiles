package JavaKonusalSorular.Pratik22_Interfcae.Pr05;

public class Main {

    public static void main(String[] args) {

    //        IMuhendis muhendis1 = newIMuhendis();
    // todo Interface den obje oluşturamayız. Sadece referans alabiliriz.

        PcMuhendisi muhendis1 = new PcMuhendisi(false, false);
    //      IMuhendis muhendis1 = new PcMuhendisi(false,false);
    // todo Burada Interface i referans aldık.
