    ...
    public class Runner {
		public static void main(String[] args) {
			...
			Mammal c2 = new Cat("X"); //kod  özel olsun istenirse obj için data tye kendi cons.
			// classtan genel olsun istenirse parent classtan creat edilmeli.babmınoglu -ademoglu
			...
			Cat c3 = new Cat();
			/* Method cagirilirken ayni isimli methodlardan hangisinin kullanilacagina Constructor karar verir.
			 Methodlari arastirmaya Consctuctor ismini tasiyan class'dan baslayin ve parentlarda arastirmaya devam edin.*/
			c3.mA(); //Animal class
			c3.mC(); //Cat class
			c3.mM(); //mammal class
			...
			/* Data Type ve Consctructor farkli classlardan ise  method arastirmaya parent olan class'dan baslayin. */
			Mammal c5 = new Cat();
			c5.mA();
			c5.mC();
			c5.mM();
