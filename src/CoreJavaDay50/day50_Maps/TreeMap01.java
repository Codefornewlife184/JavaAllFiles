...
public class TreeMap01 {
	...
	// Not : Çıktıları ayrı sayfada çıkaracağım... ordan takip edersiniz...
	...
	public static void main(String[] args) {
		...
		// 4-floorKey() method'u istenen key degeri(108) map'de yoksa kendisinden kucuk en buyuk(bir alt�) key 107 return eder.
