...
public class Pr22_SayiTahminEtmeOyunu {

	/*
	 * Sayi tahmin etme oyunu....
	 * Bilgisayardan rastle(random class kullanilarak)
	 * 0-100 arasinda bir sayi alip kullanicinin tahminini her defasinda
	 * buyuk kucuk yonlendirerek rastgele sayiyi bulmasini saglayan kod yaziniz.
	 * Random rnd = new Random(); 
	 * - int sayi = rnd.nextInt(101); 
	 * Eger kullanici ilk tahmininde bilirse x4 Kredi kazansin, 
	 * ikici tahmininde bilirse x3, 
	 * ucuncu tahmininde bilirse x2 
	 * 4 ve sonrasinda herhangi bir bonus kazanmasin kazanirsa
	 * yeni bir oyuna baslamak istiyor mu diye sor. 
	 * Baslarsa oyunu zorlastir. 
	 * Kredi seviyesi kritik duzeye indiginde yeni bir oyun hakki tani (30)
	 */
