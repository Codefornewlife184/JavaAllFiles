...
public class Pr06 {
    public static void main(String[] args) {
        ...
        //listıterator interfaceden lt1 veriable creat edildi. degerini listten assingn edildi
        while (lt1.hasNext()) {
        ...
        ListIterator lt2 = list1.listIterator();//listıterator interfaceden lt1 veriable creat edildi.
        // degerini listten assingn edildi
...
/*
trick --> hasPrevious() ve previous() method'larinin calimasi icin oncesinde
